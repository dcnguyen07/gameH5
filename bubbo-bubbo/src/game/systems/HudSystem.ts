...
import { SpecialItemPanel } from '../../ui/specialItemPanel';
...
export class HudSystem implements System {
    ...
    public specialItemPanel!: SpecialItemPanel;
    ...
    public init() {
        ...
        this.specialItemPanel = new SpecialItemPanel();
        this.specialItemPanel.game = this.game;
        ...
        this.specialItemPanel.enable(false);
        this.game.systems.get(LevelSystem).signals.onGameReady.connect(() => {
            this.specialItemPanel.enable(true);
        });
    }
    ...
    public resize(w: number, h: number) {
        ...
        this._scoreCounter.view.y = -120;

        this.specialItemPanel.view.x = -60;
        this.specialItemPanel.view.y = -30;
    }
