...
export class ResultScreen extends Container implements AppScreen {
    ...
    public prepare(data: ResultsData) {
        ...
        FirebaseEventLogger.log('game_end', data);
        this._resultsPanel.updateData(data);
        if (data.score >= data.highscore) {
            Ads.saveHighScore(data.score);
        }
    }
    ...
    public async show() {
        ...
        // Starts the animations for the background porthole detailbugs
    ...
    private _buildButtons() {
        ...
        this._playBtn.onPress.connect(() => {
            ...
            Ads.showInterstitialAds(() => {
                FirebaseEventLogger.log('inter_show', { case: 'replay' });
